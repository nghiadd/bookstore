...
<link rel="stylesheet" type="text/css" href="<?php echo SITE_URL;?>admin/css/add-product.css" media="screen, project" />
<script src="<?php echo SITE_URL;?>admin/js/jquery-1.9.1.min.js" type="text/javascript"></script>
	<!-- Ellipsis -->
