...
<script src="<?php echo SITE_URL; ?>js/jquery-1.9.1.min.js" type="text/javascript"></script>
<script src="<?php echo SITE_URL; ?>js/coin-slider.min.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?php echo SITE_URL; ?>css/coin-slider-styles.css" type="text/css" />
		...
		<div id="header">
			...
			<div id="signin-register">
				<ul>
					...
					?>" >
					<?php
					if(isset($_SESSION['_user_'])) echo "Chào <span class=\""."login_name\">".$_SESSION['_user_']['username']."</span>";
					else echo "Đăng nhập";
					?>
					</a></li>
					<li><a href="
				...
				<p><a class="account" href="<?php echo SITE_URL; ?>account.php">Thông tin tài khoản</a></p>
